    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <Card className="mt-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-lg font-semibold">Flash Vacation</h2>
            <p className="text-sm text-gray-500">
              Your trip preferences are set each time you search
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-4 text-sm text-gray-600">
          <p>
            Flash Vacation learns your preferences as you swipe and explore destinations.
            The more you use it, the better your recommendations get.
          </p>
        </div>
